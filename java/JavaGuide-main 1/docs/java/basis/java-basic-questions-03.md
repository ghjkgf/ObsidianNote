...
- [Java IO 基础知识总结](io-basis.md)
- [Java IO 设计模式总结](io-design-patterns.md)
- [Java IO 模型详解](io-model.md)
...
参考答案：[Java IO 设计模式总结](io-design-patterns.md)

### BIO、NIO 和 AIO 的区别？

参考答案：[Java IO 模型详解](io-model.md)
