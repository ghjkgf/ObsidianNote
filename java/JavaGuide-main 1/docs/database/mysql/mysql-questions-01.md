...
![脏读](concurrency-consistency-issues-dirty-reading.png)
...
![丢失修改](concurrency-consistency-issues-missing-modifications.png)
...
![不可重复读](concurrency-consistency-issues-unrepeatable-read.png)
...
![幻读](concurrency-consistency-issues-phantom-read.png)
