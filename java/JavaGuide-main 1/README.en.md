...
- [Java Basics Knowledge Points/Interview Questions Summary(1)](java-basic-questions-01.md)
- [Java Basics Knowledge Points/Interview Questions Summary(2)](java-basic-questions-01.md)
- [Java Basics Knowledge Points/Interview Questions Summary(3)](java-basic-questions-01.md)
...
- [BigDecimal solve floating point problem](bigdecimal.md)
...
3. **source code analysis** : [ArrayList source code + expansion mechanism analysis](arraylist-source-code.md),
[HashMap(JDK1.8) source code + underlying data structure analysis](docs/java/collection/ hashmap-source-code.md), 
[ConcurrentHashMap source code + underlying data structure analysis](concurrent-hash-map-source-code.md)
...
1. **Thread pool**: [Java thread pool learning summary](java-thread-pool-summary.md), [Java thread pooling best practices](java-thread-pool-best-practices.md)
2. [ThreadLocal keyword resolution](threadlocal.md)
3. [Java concurrency container summary](java-concurrent-collections.md)
4. [Atomic atomic class summary](atomic-classes.md)
5. [AQS principle and AQS synchronization component summary](aqs.md)
6. [Getting Started with CompletableFuture](completablefuture-intro.md)
...
1. **Java 8**: [Java 8 new features summary](docs/java/new-features/Java8新特性总结.md), [Java8 common new features summary](java8-common-new-features.md)
...
2. [Backend programmer essential Linux basics summary](linux-intro.md)
3. [Introduction to Shell Programming](shell-intro.md)
...
1. [Bloom filter](bloom-filter.md)
...
5. [MySQL High Performance Optimization Specification Recommendations](mysql-high-performance-optimization-specification-recommendations.md)

**Important knowledge points:**

1. [Transaction isolation level (graphic detail)](transaction-isolation-level.md)
2. [MySQL's Three Major Logs (binlog, redo log and undo log) Explained](mysql-logs.md)
3. [InnoDB storage engine implementation of MVCC](innodb-implementation-of-mvcc.md)
4. [How does a SQL statement get executed in MySQL?](how-sql-executed-in-mysql.md)
5. [Character set details: Why is it not recommended to use utf8 in MySQL?](docs/database/字符集.md)
6. [A little thought on how to store time in the database](some-thoughts-on-database-storage-time.md)

### Redis

1. [Redis FAQ Summary](redis-questions-01.md)
2. [3 common cache read and write strategies](3-commonly-used-cache-read-and-write-strategies.md)
...
Related reading: [RestFul API Brief Tutorial](RESTfulAPI.md)
...
If you have not touched Java Web development, you can first look at my summary of [J2EE Basics](J2EE基础知识.md). Although much of the content in this article is now obsolete, it will give you a deeper understanding of Java backend technology development.
...
[MyBatis Common Interview Questions Summary](mybatis-interview.md)

### Security

#### Certification Authorization

**[Fundamentals of Certification Authorization](basis-of-authority-certification.md)** In this article I will introduce the common concepts of authentication and authorization: **Authentication**, **Authorization** and **Cookie**, **Session**, Token, **OAuth 2**, **SSO**. If you are not clear about these concepts, we suggest you read this article properly.
...
Related reading: [CAP Theory and BASE Theory Explained](cap&base-theorem.md)
...
- [Why gateways? What common gateway systems do you know of?](api-gateway.md)
...
Message queues are used in distributed systems primarily for decoupling and peak shaving. Related reading: [Message Queues FAQ Summary](message-queue.md)。

1. **RabbitMQ** : [Getting Started with RabbitMQ](rabbitmq-intro.md)
2. **RocketMQ** : [Getting Started with RocketMQ](rocketmq-intro.md)、[A few simple questions and answers for RocketMQ](rocketmq-questions.md)
